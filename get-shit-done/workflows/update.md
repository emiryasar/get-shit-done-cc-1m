...
```bash
npm view get-shit-done-cc-1m version 2>/dev/null
```
...
To update manually: `npx get-shit-done-cc-1m --global`
```
...
**If LOCAL install:**
```bash
npx -y get-shit-done-cc-1m@latest --local
```

**If GLOBAL install (or unknown):**
```bash
npx -y get-shit-done-cc-1m@latest --global
```
...
[View full changelog](https://github.com/emiryasar/get-shit-done-cc-1m/blob/main/CHANGELOG.md)
```
</step>
